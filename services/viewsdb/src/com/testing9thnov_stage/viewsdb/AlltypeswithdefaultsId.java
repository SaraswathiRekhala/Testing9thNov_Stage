...
public class AlltypeswithdefaultsId implements Serializable {
    ...
    private BigDecimal doublepreccol;
    private Integer serialcol;
    private BigDecimal plainfloatcol;
    ...
    public BigDecimal getDoublepreccol() {
        return this.doublepreccol;
    }

    public void setDoublepreccol(BigDecimal doublepreccol) {
    ...
    public BigDecimal getPlainfloatcol() {
        return this.plainfloatcol;
    }

    public void setPlainfloatcol(BigDecimal plainfloatcol) {
