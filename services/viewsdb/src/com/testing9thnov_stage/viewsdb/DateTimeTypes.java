...
/**
 * DateTimeTypes generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`DateTimeTypes`")
public class DateTimeTypes implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "generator", sequenceName = "\"TABLE36_ID_seq\"" , schema = "public", allocationSize = 1)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DateTimeTypes)) return false;
        final DateTimeTypes dateTimeTypes = (DateTimeTypes) o;
        return Objects.equals(getId(), dateTimeTypes.getId());
    }
