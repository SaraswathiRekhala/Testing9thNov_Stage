...
/**
 * SampleVirtualtable generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`sample_virtualtable`")
@IdClass(SampleVirtualtableId.class)
public class SampleVirtualtable implements Serializable {
    ...
    @Id
    @Column(name = "`column`", nullable = true, scale = 0, precision = 10)
