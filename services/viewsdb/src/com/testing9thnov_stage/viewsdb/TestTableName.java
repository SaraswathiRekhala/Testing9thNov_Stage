 ...
 */
@Entity
@Table(name = "`TestTable Name`", uniqueConstraints = {
        @UniqueConstraint(name = "`UK_TestTable_Name_COLUMN2`", columnNames = {"`COLUMN2`"})})
public class TestTableName implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "generator", sequenceName = "\"TestTable Name_ID_seq\"" , schema = "public", allocationSize = 1)
