...
public class Userdetails implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "generator", sequenceName = "`userdetails_userdetaid_seq`" , schema = "public", allocationSize = 1)
    ...
    public BigDecimal getUsersal() {
        return this.usersal;
    }

    public void setUsersal(BigDecimal usersal) {
