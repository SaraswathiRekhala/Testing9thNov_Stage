...
import com.testing9thnov_stage.viewsdb.AllTypes;
import com.testing9thnov_stage.viewsdb.service.AllTypesService;
...
public AllTypes createAllTypes(@RequestPart("wm_data_json") AllTypes allTypes, @RequestPart(value = "blobColumn", required = false) MultipartFile _blobColumn) {
    ...
    public AllTypes editAllTypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        AllTypes newAllTypes = WMMultipartUtils.toObject(multipartHttpServletRequest, AllTypes.class, "viewsdb");
