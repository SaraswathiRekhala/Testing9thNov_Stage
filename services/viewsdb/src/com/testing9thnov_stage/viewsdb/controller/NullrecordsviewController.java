...
import com.testing9thnov_stage.viewsdb.service.NullrecordsviewService;
...
@ApiOperation(value = "Returns the Nullrecordsview instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Nullrecordsview getNullrecordsview(@RequestParam("username") String username,@RequestParam("password") String password,@RequestParam("role") String role,@RequestParam("usernamedeta") String usernamedeta,@RequestParam("usersal") BigDecimal usersal,@RequestParam("noofemployees") Long noofemployees,@RequestParam("isemployee") Boolean isemployee) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Nullrecordsview editNullrecordsview(@RequestParam("username") String username,@RequestParam("password") String password,@RequestParam("role") String role,@RequestParam("usernamedeta") String usernamedeta,@RequestParam("usersal") BigDecimal usersal,@RequestParam("noofemployees") Long noofemployees,@RequestParam("isemployee") Boolean isemployee, @RequestBody Nullrecordsview nullrecordsview) throws EntityNotFoundException {
