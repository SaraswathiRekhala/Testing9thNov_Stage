...
import com.testing9thnov_stage.viewsdb.Number223;
import com.testing9thnov_stage.viewsdb.Number223Id;
import com.testing9thnov_stage.viewsdb.service.Number223Service;
...
@ApiOperation(value = "Returns the Number223 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Number223 editNumber223(@RequestParam("id") Integer id,@RequestParam("integerCol") Short integerCol,@RequestParam("shortCol") Short shortCol,@RequestParam("longCol") Integer longCol,@RequestParam("bigintegerCol") Integer bigintegerCol,@RequestParam("byteCol") BigDecimal byteCol,@RequestParam("floatCol") Short floatCol,@RequestParam("doubleCol") BigDecimal doubleCol, @RequestBody Number223 number223) throws EntityNotFoundException {
