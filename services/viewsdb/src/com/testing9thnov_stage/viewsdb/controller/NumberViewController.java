...
import com.testing9thnov_stage.viewsdb.service.NumberViewService;
...
@ApiOperation(value = "Returns the NumberView instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NumberView editNumberView(@RequestParam("id") Integer id,@RequestParam("integerCol") Short integerCol,@RequestParam("shortCol") Short shortCol,@RequestParam("longCol") Integer longCol,@RequestParam("bigintegerCol") Integer bigintegerCol,@RequestParam("byteCol") BigDecimal byteCol,@RequestParam("floatCol") Short floatCol,@RequestParam("doubleCol") BigDecimal doubleCol, @RequestBody NumberView numberView) throws EntityNotFoundException {
