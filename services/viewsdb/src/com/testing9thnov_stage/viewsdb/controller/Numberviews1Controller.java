...
import com.testing9thnov_stage.viewsdb.Numberviews1;
import com.testing9thnov_stage.viewsdb.Numberviews1Id;
import com.testing9thnov_stage.viewsdb.service.Numberviews1Service;
...
@ApiOperation(value = "Returns the Numberviews1 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Numberviews1 getNumberviews1(@RequestParam("id") Integer id,@RequestParam("integerCol") Short integerCol,@RequestParam("shortCol") Short shortCol,@RequestParam("longCol") Integer longCol,@RequestParam("bigintegerCol") Integer bigintegerCol,@RequestParam("byteCol") BigDecimal byteCol,@RequestParam("floatCol") Short floatCol,@RequestParam("doubleCol") BigDecimal doubleCol) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Numberviews1 editNumberviews1(@RequestParam("id") Integer id,@RequestParam("integerCol") Short integerCol,@RequestParam("shortCol") Short shortCol,@RequestParam("longCol") Integer longCol,@RequestParam("bigintegerCol") Integer bigintegerCol,@RequestParam("byteCol") BigDecimal byteCol,@RequestParam("floatCol") Short floatCol,@RequestParam("doubleCol") BigDecimal doubleCol, @RequestBody Numberviews1 numberviews1) throws EntityNotFoundException {
