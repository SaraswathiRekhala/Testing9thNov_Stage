...
import com.testing9thnov_stage.viewsdb.SampleTable;
import com.testing9thnov_stage.viewsdb.SampleTableId;
import com.testing9thnov_stage.viewsdb.service.SampleTableService;
...
@ApiOperation(value = "Returns the SampleTable instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SampleTable getSampleTable(@RequestParam("column3") String column3,@RequestParam("column4") String column4,@RequestParam("column5") String column5,@RequestParam("id") Integer id) throws EntityNotFoundException {

        SampleTableId sampletableId = new SampleTableId();
        sampletableId.setColumn3(column3);
        sampletableId.setColumn4(column4);
        sampletableId.setColumn5(column5);
        sampletableId.setId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SampleTable editSampleTable(@RequestParam("column3") String column3,@RequestParam("column4") String column4,@RequestParam("column5") String column5,@RequestParam("id") Integer id, @RequestBody SampleTable sampleTable) throws EntityNotFoundException {

        sampleTable.setColumn3(column3);
        sampleTable.setColumn4(column4);
        sampleTable.setColumn5(column5);
        sampleTable.setId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSampleTable(@RequestParam("column3") String column3,@RequestParam("column4") String column4,@RequestParam("column5") String column5,@RequestParam("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<SampleTable> searchSampleTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering SampleTables list");
