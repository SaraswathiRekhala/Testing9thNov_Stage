...
import com.testing9thnov_stage.viewsdb.service.Table60Service;
...
public Table60 createTable60(@RequestBody Table60 table60) {
    ...
    @ApiOperation(value = "Returns the Table60 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table60 getTable60(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Getting Table60 with id: {}" , id);

        Table60 foundTable60 = table60Service.getById(id);
        LOGGER.debug("Table60 details with id: {}" , foundTable60);

        return foundTable60;
    }

    @ApiOperation(value = "Updates the Table60 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table60 editTable60(@PathVariable("id") Integer id, @RequestBody Table60 table60) throws EntityNotFoundException {
        LOGGER.debug("Editing Table60 with id: {}" , table60.getId());

        table60.setId(id);
        table60 = table60Service.update(table60);
        LOGGER.debug("Table60 details with id: {}" , table60);

        return table60;
    }

    @ApiOperation(value = "Deletes the Table60 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable60(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Table60 with id: {}" , id);

        Table60 deletedTable60 = table60Service.delete(id);

        return deletedTable60 != null;
    }
    ...
    public Page<Table60> searchTable60sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table60s list");
