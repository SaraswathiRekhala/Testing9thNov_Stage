...
import com.testing9thnov_stage.viewsdb.service.TestnumbertypesService;
...
@ApiOperation(value = "Returns the Testnumbertypes instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Testnumbertypes getTestnumbertypes(@RequestParam("deccol") BigDecimal deccol,@RequestParam("numericcol") BigDecimal numericcol,@RequestParam("floatcol") BigDecimal floatcol,@RequestParam("realcol") Double realcol,@RequestParam("doupcol") BigDecimal doupcol) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Testnumbertypes editTestnumbertypes(@RequestParam("deccol") BigDecimal deccol,@RequestParam("numericcol") BigDecimal numericcol,@RequestParam("floatcol") BigDecimal floatcol,@RequestParam("realcol") Double realcol,@RequestParam("doupcol") BigDecimal doupcol, @RequestBody Testnumbertypes testnumbertypes) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTestnumbertypes(@RequestParam("deccol") BigDecimal deccol,@RequestParam("numericcol") BigDecimal numericcol,@RequestParam("floatcol") BigDecimal floatcol,@RequestParam("realcol") Double realcol,@RequestParam("doupcol") BigDecimal doupcol) throws EntityNotFoundException {
