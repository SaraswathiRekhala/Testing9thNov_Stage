 ...
 * @see AllTypes
 */
@Service("viewsdb.AllTypesService")
@Validated
public class AllTypesServiceImpl implements AllTypesService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service viewsdb for table AllTypes to {} format", exportType);
