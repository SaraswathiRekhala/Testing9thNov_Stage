...
import com.testing9thnov_stage.viewsdb.BoolIssue;
 ...
 * @see BoolIssue
 */
@Service("viewsdb.BoolIssueService")
@Validated
public class BoolIssueServiceImpl implements BoolIssueService {
    ...
    @Autowired
    @Qualifier("viewsdb.BoolIssueDao")
	...
	public BoolIssue update(BoolIssue boolIssue) throws EntityNotFoundException {
        ...
        Integer boolissueId = boolIssue.getId();
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service viewsdb for table BoolIssue to {} format", exportType);
