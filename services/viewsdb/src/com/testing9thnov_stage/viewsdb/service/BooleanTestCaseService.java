...
public interface BooleanTestCaseService {
     ...
     */
	BooleanTestCase create(@Valid BooleanTestCase booleanTestCase);
	 ...
	 */
	BooleanTestCase update(@Valid BooleanTestCase booleanTestCase) throws EntityNotFoundException;
