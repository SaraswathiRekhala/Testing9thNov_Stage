...
public class Table2ServiceImpl implements Table2Service {
	...
	public Table2 update(Table2 table2) throws EntityNotFoundException {
        ...
        Integer table2Id = table2.getIdRename();
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service viewsdb for table Table2 to {} format", exportType);
