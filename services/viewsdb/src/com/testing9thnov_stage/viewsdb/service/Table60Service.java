...
public interface Table60Service {
	 ...
	 */
	Table60 getById(Integer table60Id) throws EntityNotFoundException;
	 ...
	 * @return Table60 associated with the given table60Id.
	 */
	Table60 findById(Integer table60Id);
	 ...
	 */
	Table60 update(@Valid Table60 table60) throws EntityNotFoundException;
	 ...
	 */
	Table60 delete(Integer table60Id) throws EntityNotFoundException;
